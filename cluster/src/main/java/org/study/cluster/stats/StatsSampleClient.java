...
import org.study.cluster.stats.StatsMessages.JobFailed;
import org.study.cluster.stats.StatsMessages.StatsJob;
import org.study.cluster.stats.StatsMessages.StatsResult;
...
public class StatsSampleClient extends AbstractActor {
    ...
    public Receive createReceive() {
        return receiveBuilder()
                ...
                .match(ClusterEvent.MemberEvent.class, other -> {
